...
Begin VB.Form frmAutomate 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(2).Control(0)=   "libExe_Action"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "libExe_File"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "libExe_Dir"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "fgText"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "cmdExe"
...
txtMonitor_IBM_File = "YREPSIT0"
txtMonitor_File = "Situ.cb"
txtMonitor_Exe = "CB_Aller.cmd"
...
X = MsgBox("Confirmez-vous l'envoi de " & Nb & " enregistrements ?" & Asc10_13 & Trim(x118), vbYesNo + vbQuestion + vbDefaultButton2, "Déclaration BAFI / CB  ")

If X = vbYes Then
    cmdMonitor_Aller_CB = cmdMonitor_Aller_Gen_Bat
Else
    cmdMonitor_Aller_CB = "Abandon"
...
X = MsgBox("Insérer une disquette pour l'envoi de " & Nb & " enregistrements ?" & Asc10_13 & Trim(X200), vbYesNo + vbQuestion + vbDefaultButton2, "Déclaration BAFI / BDP  ")

If X = vbYes Then
    msFileSystem.MoveFile xFile_TXT, "A:12179.bdp"
Else
    cmdMonitor_Aller_BDP = "Abandon"
