...
Type typeGEntité
    ...
    AdresseL1               As String * 38
    AdresseRoutage          As String * 1
    AdresseAmjDébut         As String * 8
    AdresseAmjfin           As String * 8
...
Public Sub srvGEntité_Load(recGEntitéMin As typeGEntité, recGEntitéMax As typeGEntité)
Dim mMethod As String

mMethod = Trim(recGEntitéMin.Method) & "+"
arrGEntité_NBMax = 0
arrGEntité_Suite = True: arrGEntité_NB = 0
arrGEntité_NBMax = 10: ReDim arrGEntité(arrGEntité_NBMax)

arrGEntité(0) = recGEntitéMax
arrGEntité_Suite = True
Do Until Not arrGEntité_Suite
    srvGEntité_Monitor recGEntitéMin
    recGEntitéMin = arrGEntité(arrGEntité_NB)
    recGEntitéMin.Method = mMethod
Loop
...
If recGEntité.Err = Space$(10) Then
    ...
    recGEntité.AdresseL1 = mId$(MsgTxt, K + 43, 38)
    recGEntité.AdresseRoutage = mId$(MsgTxt, K + 81, 1)
    recGEntité.AdresseAmjDébut = mId$(MsgTxt, K + 82, 8)
    recGEntité.AdresseAmjfin = mId$(MsgTxt, K + 90, 8)
'filler
    recGEntité.ElpId = CLng(Val(mId$(MsgTxt, K + 104, 12)))
    recGEntité.ElpUpdate = CInt(Val(mId$(MsgTxt, K + 116, 3)))
    recGEntité.ElpControl = mId$(MsgTxt, K + 119, 10)
...
Mid$(MsgTxt, K + 23, 81) = Space$(81)
Mid$(MsgTxt, K + 23, 19) = recGEntité.AdresseId
Mid$(MsgTxt, K + 42, 1) = recGEntité.AdresseL0K
Mid$(MsgTxt, K + 43, 38) = recGEntité.AdresseL1
Mid$(MsgTxt, K + 81, 1) = recGEntité.AdresseRoutage
Mid$(MsgTxt, K + 82, 8) = recGEntité.AdresseAmjDébut
Mid$(MsgTxt, K + 90, 8) = recGEntité.AdresseAmjfin
'filler
