...
Begin VB.Form frmBIA_ATHIC 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "BIA_ATHIC.frx":0544
      ...
      TabCaption(1)   =   "Pamamétrage"
      TabPicture(1)   =   "BIA_ATHIC.frx":0560
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "cboSelect_SQL"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "fraParam"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).ControlCount=   2
      TabCaption(2)   =   "Rapprochement SAB / CHQ_SCAN "
      TabPicture(2)   =   "BIA_ATHIC.frx":057C
      ...
      Begin VB.Frame fraParam 
         ...
         Begin VB.TextBox txtParam_MDB 
            ...
            Width           =   4815
         End
         Begin VB.TextBox txtParam_Server 
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
            ...
            Width           =   4740
         End
         Begin VB.Label lblParam_MDB 
            Caption         =   "chemin + nom du fichier *****.mdb"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
            ...
            Width           =   3360
         End
         Begin VB.Label lblParam_Server 
            Caption         =   "chemin du répertoire .......\Images\"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.Frame fraTab0 
         ...
         Begin MSFlexGridLib.MSFlexGrid fgDossier 
            ...
            GridLinesFixed  =   1
            AllowUserResizing=   3
            FormatString    =   $"BIA_ATHIC.frx":0598
         ...
         Begin MSFlexGridLib.MSFlexGrid fgSelect 
            ...
            GridLinesFixed  =   1
            AllowUserResizing=   3
            FormatString    =   $"BIA_ATHIC.frx":067D
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.Frame fraDétail 
         ...
         Begin MSFlexGridLib.MSFlexGrid fgCHQRC1 
            ...
            GridLinesFixed  =   1
            AllowUserResizing=   3
            FormatString    =   $"BIA_ATHIC.frx":070C
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Courier New"
               Size            =   8.25
               Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmBIA_ATHIC"
...
X = "select * from CHEQUE  where ID = 'R' and Date >= '" & wAMJMin & "' and Date <= '" & WAMJMax & "' and StatutRem = 'AJ' order by Devise ,CodeDevise , Nature , Date"
    
    Set rsSab = cnADO_ATHIC.Execute(X)
...
Do While Not rsSab.EOF
    ...
    If xCHQ_SCAN.CodeDevise = "ETR" Then xCHQ_SCAN.Nature = "ETR"
...
txtParam_MDB = paramATHIC_MDB
txtParam_Server = paramATHIC_Images
fraParam.Visible = arrHab(19)
...
Old_YBIATAB0.BIATABID = "BIA_ATHIC"
Old_YBIATAB0.BIATABK1 = "MDB"
Old_YBIATAB0.BIATABK2 = ""
Call sqlYBIATAB0_Read(Old_YBIATAB0.BIATABID, Old_YBIATAB0.BIATABK1, Old_YBIATAB0.BIATABK2, Old_YBIATAB0.BIATABTXT)
New_YBIATAB0 = Old_YBIATAB0
New_YBIATAB0.BIATABTXT = Trim(txtParam_MDB)
Call Parametrage_Update

Old_YBIATAB0.BIATABID = "BIA_ATHIC"
Old_YBIATAB0.BIATABK1 = "Server"
Old_YBIATAB0.BIATABK2 = ""
Call sqlYBIATAB0_Read(Old_YBIATAB0.BIATABID, Old_YBIATAB0.BIATABK1, Old_YBIATAB0.BIATABK2, Old_YBIATAB0.BIATABTXT)
New_YBIATAB0 = Old_YBIATAB0
New_YBIATAB0.BIATABTXT = Trim(txtParam_Server)
Call Parametrage_Update
...
mnuImport.Enabled = arrHab(19)
mnuExport.Enabled = arrHab(19)
mnuDelete.Enabled = arrHab(19)
mnuUpdate_Table.Enabled = arrHab(19)
mnuUpdate_DEON.Enabled = arrHab(19)
mnuDéontologie.Enabled = arrHab(19)
mnuDéontologie_Image.Enabled = arrHab(19)
''mnuDéontologie_ZIB.Enabled = arrhab(19)

mnuRapprochement_SAB.Enabled = arrHab(19)
mnuRapprochement_CHQ_SCAN.Enabled = arrHab(19)
mnuRapprochement_Semi_Automatique.Enabled = arrHab(19)
mnuRapprochement_Manuel.Enabled = arrHab(5)
mnuRapprochement_Automatique.Enabled = arrHab(5)
...
Do Until EOF(wIdFile_Source)
    ...
    xCHQ_SCAN.Devise = CSV_Scan(xIn, K)
        ...
        Call sqlCHQ_SCAN_Insert(xCHQ_SCAN, cnADO_ATHIC)
...
X = MsgBox("Confirmer la suppression de cette remise ?", vbYesNo + vbQuestion + vbDefaultButton2, "Suppression de la remise : " & xCHQ_SCAN.CRem)
If X = vbNo Then Exit Sub

'Suppression des enregistrements de la table CHEQUE
'====================================================
    
V = sqlCHQ_SCAN_Delete(oldCHQ_SCAN, rsSab, cnADO_ATHIC)
...
If IsNull(fraSelect_Update_Control) Then
        ...
        V = sqlCHQ_SCAN_Update(newCHQ_SCAN, oldCHQ_SCAN, rsSab, cnADO_ATHIC)
...
Dim X As String
MsgBox "cmdStatut_Ok_Remise à revoir", vbInformation, "BIA_ATHIC"
Exit Sub
...
For K = 1 To arrCHQ_SCAN_Nb
    ...
    ''wPath = paramATHIC_Images & "\" & xRemise.Date & "\Archive\"

    wSendMail.Attachment = ""

    For K2 = 1 To arrCHQ_SCAN_Détail_Nb
        xCHQ_SCAN = arrCHQ_SCAN_Détail(K2)
        wSendMail.Attachment = wSendMail.Attachment _
                             & Replace(xCHQ_SCAN.PATH, "I:\ATHIC\", paramATHIC_Images) & "\" & Trim(xCHQ_SCAN.IMAGE) & ".jpg" & ";"
...
blnRapprochement_Action = arrHab(5)
...
'
'========================================================================================================
X = "select *  from " & paramIBM_Library_SAB & ".ZGUIRC10 where GUIRC1CEF = '1' and GUIRC1DCR >= " & (wAmj - 19000000) _
  & " and GUIRC1CTA <> '4'"
...
Do While Not rsSab_Local.EOF
 ...
 '========================
        ...
        If Not IsNull(rsYCHQMON0_Read(xYCHQMON0)) Then
            sqlYCHQMON0_Insert xYCHQMON0
        Else
            wMsg = ""
            If xYCHQMON0.CHQMONSTA = "=" Then
                If xYCHQMON0.CHQCOMPTE <> xZGUIRC10.GUIRC1CP2 Then
                    wMsg = wMsg & " - Compte : " & xYCHQMON0.CHQCOMPTE & " =>" & xZGUIRC10.GUIRC1CP2 & vbCrLf
                End If
                'If xYCHQMON0.CHQCREM <> xZGUIRC10.GUIRC1NAT Then
                '    wMsg = wMsg & " - Nature : " & xYCHQMON0.CHQCREM & " =>" & xZGUIRC10.GUIRC1NAT & vbCrLf
                'End If
                If xYCHQMON0.CHQDEVISE <> xZGUIRC10.GUIRC1DE1 Then
                    wMsg = wMsg & " - Devise : " & xYCHQMON0.CHQDEVISE & " =>" & xZGUIRC10.GUIRC1DE1 & vbCrLf
                End If
                If xYCHQMON0.CHQMONTANT <> xZGUIRC10.GUIRC1MO2 Then
                    wMsg = wMsg & " - Montant : " & xYCHQMON0.CHQMONTANT & " =>" & xZGUIRC10.GUIRC1MO2 & vbCrLf
                End If

                If wMsg <> "" Then
                    Call MsgBox("L'enregistrement SAB : " & xZGUIRC10.GUIRC1DOS & " a été modifié depuis le rapprochement : " & vbCrLf _
                                  & wMsg, vbInformation, "CHQ_SCAN : anomalie de rapprochement SAB # ATHIC")
                End If
            End If
        End If
    End If
...
'20050927_JPL Set rsSab = cnADO_ATHIC.Execute(xSql)
...
'20050927_JPL V = sqlCHQ_SCAN_Insert(autoDéontologie, cnADO_ATHIC)
...
'===================================================
xWhere = "Where Date = '20120514' and CRem = '00025786' "
...
Else
    ...
    xSQL = "Update CHEQUE set ZONE1 = '000000004020' " & xWhere
    Call FEU_ROUGE
    Set rsSab = cnADO_ATHIC.Execute(xSQL)
    Call FEU_VERT
End If
xWhere = "Where Date = '20120514' and CRem = '00025811' "
...
Else
    Debug.Print rsSab("ZONE1"), rsSab("ZONE2")
    xSQL = "Update CHEQUE set ZONE1 = '000000024481' " & xWhere
    Call FEU_ROUGE
    Set rsSab = cnADO_ATHIC.Execute(xSQL)
    Call FEU_VERT
End If
...
If Not blnTransaction Then
    blnTransaction = True
   ' Set rsSab_Update = cnADO_ATHIC.Execute("SET TRANSACTION ISOLATION LEVEL READ COMMITTED")
...
End If
    ...
    cmdSelect_Delete.Visible = arrHab(5) 'arrHab(19)
    cmdSelect_Update_Ok.Visible = arrHab(5) 'arrHab(19)
...
'20050927_JPL     V = sqlCHQ_SCAN_Update(newCHQ_SCAN, autoDéontologie, rsSab, cnADO_ATHIC)
'--------------------------------------------------------------------------------------
...
XPrt.CurrentY = XPrt.CurrentY + 4450
 '   xPath_ImgCHQ = paramATHIC_Images & "\"
...
xPath_ImgCHQ = Replace(xCHQ_SCAN.PATH, "I:\ATHIC\", paramATHIC_Images) & "\" & Trim(xCHQ_SCAN.IMAGE) & ".jpg"
...
End If
If blnImgCHQ_Verso Then
    xPath_ImgCHQ = Replace(xCHQ_SCAN.PATH, "I:\ATHIC\", paramATHIC_Images) & "\ba" & Trim(xCHQ_SCAN.IMAGE) & ".jpg"
    If Dir(xPath_ImgCHQ) <> "" Then
