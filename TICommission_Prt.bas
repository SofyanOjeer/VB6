Attribute VB_Name = "prtTICommission"
'---------------------------------------------------------
Option Explicit
'---------------------------------------------------------
...
'---------------------------------------------------------
 Public Sub prtTICommission_Monitor(Msg As String)
'---------------------------------------------------------
...
If blnExportTICom Then Open "D:\Temp\TICom.txt" For Output As #1
        ...
        If mCDDossier_AMJSituation = selprtStatut Then
            ...
            'If curX <> 0 Or curS36 <> 0 Then
                If blnExportTICom Then
                    prtTICommission_Export
                Else
                    prtTICommission_Line
                End If
            'End If
        End If
...
If blnExportTICom Then prtTICommission_Export: Close
        
If mCDDossier_AMJSituation = selprtStatut Then prtTICommission_Line
prtTICommission_Total
...
End Sub
'---------------------------------------------------------
Public Sub prtTICommission_Form()
'---------------------------------------------------------
Dim X As String
XPrt.FontSize = 6
...
'---------------------------------------------------------
Public Sub prtTICommission_Line()
'---------------------------------------------------------
...
'jpl 20010206    prtTICommission_Total
...
prtTICommission_Line_Détail

End Sub

'---------------------------------------------------------
Public Sub prtTICommission_Export()
'---------------------------------------------------------
...
'---------------------------------------------------------
Public Sub prtTICommission_Line_Détail()
'---------------------------------------------------------
...
Public Sub prtTICommission_Line_Init()
...
Public Sub prtTICommission_Total()
