...
Public Function srvZSWIFTB0_Sql_Insert(lZSWIFTB0 As typeZSWIFTB0, lSql As String)
On Error GoTo Error_Handler
srvZSWIFTB0_Sql_Insert = Null
lSql = "Insert into " & paramIBM_Library_SAB & ".ZSWIFTB0 " _
        & "(SWIFTBETA,SWIFTBNUM,SWIFTBNEN,SWIFTBNLI,SWIFTBDET) values ( " _
        & lZSWIFTB0.SWIFTBETA _
        & "," & lZSWIFTB0.SWIFTBNUM _
        & "," & lZSWIFTB0.SWIFTBNEN _
        & "," & lZSWIFTB0.SWIFTBNLI _
        & ",'" & lZSWIFTB0.SWIFTBDET & "')"
        
Exit Function
Error_Handler:
srvZSWIFTB0_Sql_Insert = Error
End Function

Public Function srvZSWIHIC0_Sql_Sauvegarde(lZSWIFTC0 As typeZSWIFTC0, lSql As String)
On Error GoTo Error_Handler
srvZSWIHIC0_Sql_Sauvegarde = Null
lSql = "Insert into " & paramIBM_Library_SAB & ".ZSWIHIC0 " _
          ...
          & " ) values ( " _
        & lZSWIFTC0.SWIFTCETA _
        & "," & lZSWIFTC0.SWIFTCNUM _
        & "," & lZSWIFTC0.SWIFTCNEN _
        & "," & lZSWIFTC0.SWIFTCNLI _
        & ",'" & lZSWIFTC0.SWIFTCNSE & "'" _
        & "," & lZSWIFTC0.SWIFTCSOC _
        & "," & lZSWIFTC0.SWIFTCNCH _
        & "," & lZSWIFTC0.SWIFTCCOC _
        & "," & lZSWIFTC0.SWIFTCNLC _
        & ",'" & lZSWIFTC0.SWIFTCSEQ & "'" _
        & ",'" & lZSWIFTC0.SWIFTCCHA & "'" _
        & ",'" & lZSWIFTC0.SWIFTCILI & "'" _
        & ",'" & lZSWIFTC0.SWIFTCFAC & "'" _
        & ",'" & lZSWIFTC0.SWIFTCSIG & "'" _
        & "," & lZSWIFTC0.SWIFTCSMA _
        & "," & lZSWIFTC0.SWIFTCCMA _
        & "," & lZSWIFTC0.SWIFTCSMI _
        & "," & lZSWIFTC0.SWIFTCCMI & ")"

Exit Function
Error_Handler:
srvZSWIHIC0_Sql_Sauvegarde = Error
End Function

Public Function srvZSWIHIA0_Sql_Sauvegarde(lZSWIFTA0 As typeZSWIFTA0, lSql As String)
On Error GoTo Error_Handler
srvZSWIHIA0_Sql_Sauvegarde = Null
lSql = "Insert into " & paramIBM_Library_SAB & ".ZSWIHIA0 " _
        ...
        & lZSWIFTA0.SWIFTAETA _
        & ",'" & lZSWIFTA0.SWIFTAREF & "','" & lZSWIFTA0.SWIFTANEN & "'" _
        & ",'" & lZSWIFTA0.SWIFTAPRI & "','" & lZSWIFTA0.SWIFTAMES & "'" _
        & ",'" & lZSWIFTA0.SWIFTADOR & "','" & lZSWIFTA0.SWIFTADES & "'" _
        & "," & lZSWIFTA0.SWIFTADVA & ",'" & lZSWIFTA0.SWIFTADE1 & "'" _
        & "," & lZSWIFTA0.SWIFTAMON & ",'" & lZSWIFTA0.SWIFTADE2 & "'" _
        & "," & lZSWIFTA0.SWIFTADEN _
        & "," & lZSWIFTA0.SWIFTAHEN _
        & ",'" & lZSWIFTA0.SWIFTACOM & "'" _
        & ",'" & lZSWIFTA0.SWIFTATES & "'" _
        & ",'" & lZSWIFTA0.SWIFTASUP & "'" _
        & ",'" & lZSWIFTA0.SWIFTAVAL & "'" _
        & "," & lZSWIFTA0.SWIFTAAGE _
        & ",'" & lZSWIFTA0.SWIFTASER & "'" _
        & ",'" & lZSWIFTA0.SWIFTASSE & "'" _
        & ",'" & lZSWIFTA0.SWIFTAUTI & "'" _
        & "," & lZSWIFTA0.SWIFTANUM _
        & ",'" & lZSWIFTA0.SWIFTAUT1 & "'" _
        & ",'" & lZSWIFTA0.SWIFTAPVA & "'" _
        & ",'" & lZSWIFTA0.SWIFTAUT2 & "')"

Exit Function
Error_Handler:
srvZSWIHIA0_Sql_Sauvegarde = Error


End Function

Public Function srvZSWIHIT0_Sql_Sauvegarde(lZSWITEM0 As typeZSWITEM0, lSql As String)
On Error GoTo Error_Handler
srvZSWIHIT0_Sql_Sauvegarde = Null
Dim K As Integer
' Supprimer le charactère ' dans la requête SQL
Do
    K = InStr(lZSWITEM0.SWITEMVAL, "'")
    If K > 0 Then Mid$(lZSWITEM0.SWITEMVAL, K, 1) = " "
Loop Until K = 0
...
lSql = "Insert into " & paramIBM_Library_SAB & ".ZSWIHIT0 " _
          ...
          & " ) values ( " _
        & lZSWITEM0.SWITEMETA _
        & "," & lZSWITEM0.SWITEMNUM _
        & "," & lZSWITEM0.SWITEMNEN _
        & ",'" & lZSWITEM0.SWITEMNSE & "'" _
        & ",'" & lZSWITEM0.SWITEMSEQ & "'" _
        & "," & lZSWITEM0.SWITEMOSE _
        & "," & lZSWITEM0.SWITEMCHA _
        & "," & lZSWITEM0.SWITEMOCH _
        & ",'" & lZSWITEM0.SWITEMIND & "'" _
        & "," & lZSWITEM0.SWITEMZON _
        & "," & lZSWITEM0.SWITEMOZO _
        & "," & lZSWITEM0.SWITEMSZO _
        & "," & lZSWITEM0.SWITEMOSZ _
        & "," & lZSWITEM0.SWITEMCON _
        & ",'" & lZSWITEM0.SWITEMCOM & "'" _
        & ",'" & lZSWITEM0.SWITEMVAL & "')"

Exit Function
Error_Handler:
srvZSWIHIT0_Sql_Sauvegarde = Error
End Function


Public Function srvZSWIFTA0_Sql_Restauration(lZSWIHIA0 As typeZSWIHIA0, lSql As String)
On Error GoTo Error_Handler
srvZSWIFTA0_Sql_Restauration = Null
lSql = "Insert into " & paramIBM_Library_SAB & ".ZSWIFTA0 " _
        ...
        & lZSWIHIA0.SWIHIAETA _
        & ",'" & lZSWIHIA0.SWIHIAREF & "','" & lZSWIHIA0.SWIHIANEN & "'" _
        & ",'" & lZSWIHIA0.SWIHIAPRI & "','" & lZSWIHIA0.SWIHIAMES & "'" _
        & ",'" & lZSWIHIA0.SWIHIADOR & "','" & lZSWIHIA0.SWIHIADES & "'" _
        & "," & lZSWIHIA0.SWIHIADVA & ",'" & lZSWIHIA0.SWIHIADE1 & "'" _
        & "," & lZSWIHIA0.SWIHIAMON & ",'" & lZSWIHIA0.SWIHIADE2 & "'" _
        & "," & lZSWIHIA0.SWIHIADEN _
        & "," & lZSWIHIA0.SWIHIAHEN _
        & ",'" & lZSWIHIA0.SWIHIACOM & "'" _
        & ",'" & lZSWIHIA0.SWIHIATES & "'" _
        & ",'" & lZSWIHIA0.SWIHIASUP & "'" _
        & ",'" & lZSWIHIA0.SWIHIAVAL & "'" _
        & "," & lZSWIHIA0.SWIHIAAGE _
        & ",'" & lZSWIHIA0.SWIHIASER & "'" _
        & ",'" & lZSWIHIA0.SWIHIASSE & "'" _
        & ",'" & lZSWIHIA0.SWIHIAUTI & "'" _
        & "," & lZSWIHIA0.SWIHIANUM _
        & ",'" & lZSWIHIA0.SWIHIAUT1 & "'" _
        & ",'" & lZSWIHIA0.SWIHIAPVA & "'" _
        & ",'" & lZSWIHIA0.SWIHIAUT2 & "')"

Exit Function
Error_Handler:
srvZSWIFTA0_Sql_Restauration = Error


End Function

Public Function srvZSWIFTB0_Sql_Restauration(lZSWIHIB0 As typeZSWIHIB0, lSql As String)
On Error GoTo Error_Handler
Dim K As Integer
' Supprimer le charactère ' dans la requête SQL
Do
    K = InStr(lZSWIHIB0.SWIHIBDET, "'")
    If K > 0 Then Mid$(lZSWIHIB0.SWIHIBDET, K, 1) = " "
Loop Until K = 0

srvZSWIFTB0_Sql_Restauration = Null
lSql = "Insert into " & paramIBM_Library_SAB & ".ZSWIFTB0 " _
        & "(SWIFTBETA,SWIFTBNUM,SWIFTBNEN,SWIFTBNLI,SWIFTBDET) values ( " _
        & lZSWIHIB0.SWIHIBETA _
        & "," & lZSWIHIB0.SWIHIBNUM _
        & "," & lZSWIHIB0.SWIHIBNEN _
        & "," & lZSWIHIB0.SWIHIBNLI _
        & ",'" & lZSWIHIB0.SWIHIBDET & "')"
        
Exit Function
Error_Handler:
srvZSWIFTB0_Sql_Restauration = Error
End Function



Public Function srvZSWIFTC0_Sql_Restauration(lZSWIHIC0 As typeZSWIHIC0, lSql As String)
On Error GoTo Error_Handler
srvZSWIFTC0_Sql_Restauration = Null
lSql = "Insert into " & paramIBM_Library_SAB & ".ZSWIFTC0 " _
          ...
          & " ) values ( " _
        & lZSWIHIC0.SWIHICETA _
        & "," & lZSWIHIC0.SWIHICNUM _
        & "," & lZSWIHIC0.SWIHICNEN _
        & "," & lZSWIHIC0.SWIHICNLI _
        & ",'" & lZSWIHIC0.SWIHICNSE & "'" _
        & "," & lZSWIHIC0.SWIHICSOC _
        & "," & lZSWIHIC0.SWIHICNCH _
        & "," & lZSWIHIC0.SWIHICCOC _
        & "," & lZSWIHIC0.SWIHICNLC _
        & ",'" & lZSWIHIC0.SWIHICSEQ & "'" _
        & ",'" & lZSWIHIC0.SWIHICCHA & "'" _
        & ",'" & lZSWIHIC0.SWIHICILI & "'" _
        & ",'" & lZSWIHIC0.SWIHICFAC & "'" _
        & ",'" & lZSWIHIC0.SWIHICSIG & "'" _
        & "," & lZSWIHIC0.SWIHICSMA _
        & "," & lZSWIHIC0.SWIHICCMA _
        & "," & lZSWIHIC0.SWIHICSMI _
        & "," & lZSWIHIC0.SWIHICCMI & ")"

Exit Function
Error_Handler:
srvZSWIFTC0_Sql_Restauration = Error
End Function

Public Function srvZSWITEM0_Sql_Restauration(lZSWIHIT0 As typeZSWIHIT0, lSql As String)
On Error GoTo Error_Handler
srvZSWITEM0_Sql_Restauration = Null
Dim K As Integer
' Supprimer le charactère ' dans la requête SQL
Do
    K = InStr(lZSWIHIT0.SWIHITVAL, "'")
    If K > 0 Then Mid$(lZSWIHIT0.SWIHITVAL, K, 1) = " "
Loop Until K = 0
...
lSql = "Insert into " & paramIBM_Library_SAB & ".ZSWITEM0 " _
          ...
          & " ) values ( " _
        & lZSWIHIT0.SWIHITETA _
        & "," & lZSWIHIT0.SWIHITNUM _
        & "," & lZSWIHIT0.SWIHITNEN _
        & ",'" & lZSWIHIT0.SWIHITNSE & "'" _
        & ",'" & lZSWIHIT0.SWIHITSEQ & "'" _
        & "," & lZSWIHIT0.SWIHITOSE _
        & "," & lZSWIHIT0.SWIHITCHA _
        & "," & lZSWIHIT0.SWIHITOCH _
        & ",'" & lZSWIHIT0.SWIHITIND & "'" _
        & "," & lZSWIHIT0.SWIHITZON _
        & "," & lZSWIHIT0.SWIHITOZO _
        & "," & lZSWIHIT0.SWIHITSZO _
        & "," & lZSWIHIT0.SWIHITOSZ _
        & "," & lZSWIHIT0.SWIHITCON _
        & ",'" & lZSWIHIT0.SWIHITCOM & "'" _
        & ",'" & lZSWIHIT0.SWIHITVAL & "')"

Exit Function
Error_Handler:
srvZSWITEM0_Sql_Restauration = Error
End Function




Public Function srvZSWIHIB0_Sql_Sauvegarde(lZSWIFTB0 As typeZSWIFTB0, lSql As String)
On Error GoTo Error_Handler
Dim K As Integer
' Supprimer le charactère ' dans la requête SQL

Do
    K = InStr(lZSWIFTB0.SWIFTBDET, "'")
    If K > 0 Then Mid$(lZSWIFTB0.SWIFTBDET, K, 1) = " "
Loop Until K = 0

srvZSWIHIB0_Sql_Sauvegarde = Null
...
Exit Function
Error_Handler:
srvZSWIHIB0_Sql_Sauvegarde = Error
End Function

Public Sub srvZSWIFTA0_Init(lZSWIFTA0 As typeZSWIFTA0)
lZSWIFTA0.SWIFTAETA = 0
lZSWIFTA0.SWIFTAREF = ""
lZSWIFTA0.SWIFTANEN = ""
lZSWIFTA0.SWIFTAPRI = ""
lZSWIFTA0.SWIFTAMES = ""
lZSWIFTA0.SWIFTADOR = ""
lZSWIFTA0.SWIFTADES = ""
lZSWIFTA0.SWIFTADVA = 0
lZSWIFTA0.SWIFTADE1 = ""
lZSWIFTA0.SWIFTAMON = 0
lZSWIFTA0.SWIFTADE2 = ""
lZSWIFTA0.SWIFTADEN = 0
lZSWIFTA0.SWIFTAHEN = 0
lZSWIFTA0.SWIFTACOM = ""
lZSWIFTA0.SWIFTATES = ""
lZSWIFTA0.SWIFTASUP = ""
lZSWIFTA0.SWIFTAVAL = ""
lZSWIFTA0.SWIFTAAGE = 0
lZSWIFTA0.SWIFTASER = ""
lZSWIFTA0.SWIFTASSE = ""
lZSWIFTA0.SWIFTAUTI = ""
lZSWIFTA0.SWIFTANUM = 0
lZSWIFTA0.SWIFTAUT1 = ""
lZSWIFTA0.SWIFTAPVA = ""
lZSWIFTA0.SWIFTAUT2 = ""
End Sub
...
End Function
Public Function srvZSWIALI0_GetBuffer_ODBC(rsado As ADODB.Recordset, lZSWIALI0 As typeZSWIALI0)
On Error GoTo Error_Handler
srvZSWIALI0_GetBuffer_ODBC = Null
lZSWIALI0.SWIALIETA = rsado("SWIALIETA")
lZSWIALI0.SWIALIAGE = rsado("SWIALIAGE")
lZSWIALI0.SWIALISER = rsado("SWIALISER")
lZSWIALI0.SWIALISSE = rsado("SWIALISSE")
lZSWIALI0.SWIALIMES = rsado("SWIALIMES")
lZSWIALI0.SWIALINUM = rsado("SWIALINUM")
lZSWIALI0.SWIALINEN = rsado("SWIALINEN")
lZSWIALI0.SWIALINLI = rsado("SWIALINLI")
lZSWIALI0.SWIALIDON = rsado("SWIALIDON")
lZSWIALI0.SWIALIOK = rsado("SWIALIOK")
Exit Function
Error_Handler:
srvZSWIALI0_GetBuffer_ODBC = Error
End Function
...
End Function
Public Function srvZSWIFTA0_GetBuffer_ODBC(rsado As ADODB.Recordset, lZSWIFTA0 As typeZSWIFTA0)
On Error GoTo Error_Handler
srvZSWIFTA0_GetBuffer_ODBC = Null
lZSWIFTA0.SWIFTAETA = rsado("SWIFTAETA")
lZSWIFTA0.SWIFTAREF = rsado("SWIFTAREF")
lZSWIFTA0.SWIFTANEN = rsado("SWIFTANEN")
lZSWIFTA0.SWIFTAPRI = rsado("SWIFTAPRI")
lZSWIFTA0.SWIFTAMES = rsado("SWIFTAMES")
lZSWIFTA0.SWIFTADOR = rsado("SWIFTADOR")
lZSWIFTA0.SWIFTADES = rsado("SWIFTADES")
lZSWIFTA0.SWIFTADVA = rsado("SWIFTADVA")
lZSWIFTA0.SWIFTADE1 = rsado("SWIFTADE1")
lZSWIFTA0.SWIFTAMON = rsado("SWIFTAMON")
lZSWIFTA0.SWIFTADE2 = rsado("SWIFTADE2")
lZSWIFTA0.SWIFTADEN = rsado("SWIFTADEN")
lZSWIFTA0.SWIFTAHEN = rsado("SWIFTAHEN")
lZSWIFTA0.SWIFTACOM = rsado("SWIFTACOM")
lZSWIFTA0.SWIFTATES = rsado("SWIFTATES")
lZSWIFTA0.SWIFTASUP = rsado("SWIFTASUP")
lZSWIFTA0.SWIFTAVAL = rsado("SWIFTAVAL")
lZSWIFTA0.SWIFTAAGE = rsado("SWIFTAAGE")
lZSWIFTA0.SWIFTASER = rsado("SWIFTASER")
lZSWIFTA0.SWIFTASSE = rsado("SWIFTASSE")
lZSWIFTA0.SWIFTAUTI = rsado("SWIFTAUTI")
lZSWIFTA0.SWIFTANUM = rsado("SWIFTANUM")
lZSWIFTA0.SWIFTAUT1 = rsado("SWIFTAUT1")
lZSWIFTA0.SWIFTAPVA = rsado("SWIFTAPVA")
lZSWIFTA0.SWIFTAUT2 = rsado("SWIFTAUT2")
Exit Function
Error_Handler:
srvZSWIFTA0_GetBuffer_ODBC = Error
End Function
Public Function srvZSWIFTB0_GetBuffer_ODBC(rsado As ADODB.Recordset, lZSWIFTB0 As typeZSWIFTB0)
On Error GoTo Error_Handler
srvZSWIFTB0_GetBuffer_ODBC = Null
lZSWIFTB0.SWIFTBETA = rsado("SWIFTBETA")
lZSWIFTB0.SWIFTBNUM = rsado("SWIFTBNUM")
lZSWIFTB0.SWIFTBNEN = rsado("SWIFTBNEN")
lZSWIFTB0.SWIFTBNLI = rsado("SWIFTBNLI")
lZSWIFTB0.SWIFTBDET = rsado("SWIFTBDET")
Exit Function
Error_Handler:
srvZSWIFTB0_GetBuffer_ODBC = Error
End Function
Public Function srvZSWIFTC0_GetBuffer_ODBC(rsado As ADODB.Recordset, lZSWIFTC0 As typeZSWIFTC0)
On Error GoTo Error_Handler
srvZSWIFTC0_GetBuffer_ODBC = Null
lZSWIFTC0.SWIFTCETA = rsado("SWIFTCETA")
lZSWIFTC0.SWIFTCNUM = rsado("SWIFTCNUM")
lZSWIFTC0.SWIFTCNEN = rsado("SWIFTCNEN")
lZSWIFTC0.SWIFTCNLI = rsado("SWIFTCNLI")
lZSWIFTC0.SWIFTCNSE = rsado("SWIFTCNSE")
lZSWIFTC0.SWIFTCSOC = rsado("SWIFTCSOC")
lZSWIFTC0.SWIFTCNCH = rsado("SWIFTCNCH")
lZSWIFTC0.SWIFTCCOC = rsado("SWIFTCCOC")
lZSWIFTC0.SWIFTCNLC = rsado("SWIFTCNLC")
lZSWIFTC0.SWIFTCSEQ = rsado("SWIFTCSEQ")
lZSWIFTC0.SWIFTCCHA = rsado("SWIFTCCHA")
lZSWIFTC0.SWIFTCILI = rsado("SWIFTCILI")
lZSWIFTC0.SWIFTCFAC = rsado("SWIFTCFAC")
lZSWIFTC0.SWIFTCSIG = rsado("SWIFTCSIG")
lZSWIFTC0.SWIFTCSMA = rsado("SWIFTCSMA")
lZSWIFTC0.SWIFTCCMA = rsado("SWIFTCCMA")
lZSWIFTC0.SWIFTCSMI = rsado("SWIFTCSMI")
lZSWIFTC0.SWIFTCCMI = rsado("SWIFTCCMI")
Exit Function
Error_Handler:
srvZSWIFTC0_GetBuffer_ODBC = Error
End Function
...
End Function
Public Function srvZSWIHIA0_GetBuffer_ODBC(rsado As ADODB.Recordset, lZSWIHIA0 As typeZSWIHIA0)
On Error GoTo Error_Handler
srvZSWIHIA0_GetBuffer_ODBC = Null
lZSWIHIA0.SWIHIAETA = rsado("SWIHIAETA")
lZSWIHIA0.SWIHIAREF = rsado("SWIHIAREF")
lZSWIHIA0.SWIHIANEN = rsado("SWIHIANEN")
lZSWIHIA0.SWIHIAPRI = rsado("SWIHIAPRI")
lZSWIHIA0.SWIHIAMES = rsado("SWIHIAMES")
lZSWIHIA0.SWIHIADOR = rsado("SWIHIADOR")
lZSWIHIA0.SWIHIADES = rsado("SWIHIADES")
lZSWIHIA0.SWIHIADVA = rsado("SWIHIADVA")
lZSWIHIA0.SWIHIADE1 = rsado("SWIHIADE1")
lZSWIHIA0.SWIHIAMON = rsado("SWIHIAMON")
lZSWIHIA0.SWIHIADE2 = rsado("SWIHIADE2")
lZSWIHIA0.SWIHIADEN = rsado("SWIHIADEN")
lZSWIHIA0.SWIHIAHEN = rsado("SWIHIAHEN")
lZSWIHIA0.SWIHIACOM = rsado("SWIHIACOM")
lZSWIHIA0.SWIHIATES = rsado("SWIHIATES")
lZSWIHIA0.SWIHIASUP = rsado("SWIHIASUP")
lZSWIHIA0.SWIHIAVAL = rsado("SWIHIAVAL")
lZSWIHIA0.SWIHIAAGE = rsado("SWIHIAAGE")
lZSWIHIA0.SWIHIASER = rsado("SWIHIASER")
lZSWIHIA0.SWIHIASSE = rsado("SWIHIASSE")
lZSWIHIA0.SWIHIAUTI = rsado("SWIHIAUTI")
lZSWIHIA0.SWIHIANUM = rsado("SWIHIANUM")
lZSWIHIA0.SWIHIAUT1 = rsado("SWIHIAUT1")
lZSWIHIA0.SWIHIAPVA = rsado("SWIHIAPVA")
lZSWIHIA0.SWIHIAUT2 = rsado("SWIHIAUT2")
Exit Function
Error_Handler:
srvZSWIHIA0_GetBuffer_ODBC = Error
End Function
Public Function srvZSWIHIB0_GetBuffer_ODBC(rsado As ADODB.Recordset, lZSWIHIB0 As typeZSWIHIB0)
On Error GoTo Error_Handler
srvZSWIHIB0_GetBuffer_ODBC = Null
lZSWIHIB0.SWIHIBETA = rsado("SWIHIBETA")
lZSWIHIB0.SWIHIBNUM = rsado("SWIHIBNUM")
lZSWIHIB0.SWIHIBNEN = rsado("SWIHIBNEN")
lZSWIHIB0.SWIHIBNLI = rsado("SWIHIBNLI")
lZSWIHIB0.SWIHIBDET = rsado("SWIHIBDET")
Exit Function
Error_Handler:
srvZSWIHIB0_GetBuffer_ODBC = Error
End Function
Public Function srvZSWIFTB0_ZSWIHIB0(lZSWIFTB0 As typeZSWIFTB0, lZSWIHIB0 As typeZSWIHIB0)
On Error GoTo Error_Handler
srvZSWIFTB0_ZSWIHIB0 = Null
lZSWIHIB0.SWIHIBETA = lZSWIFTB0.SWIFTBETA
lZSWIHIB0.SWIHIBNUM = lZSWIFTB0.SWIFTBNUM
lZSWIHIB0.SWIHIBNEN = lZSWIFTB0.SWIFTBNEN
lZSWIHIB0.SWIHIBNLI = lZSWIFTB0.SWIFTBNLI
lZSWIHIB0.SWIHIBDET = lZSWIFTB0.SWIFTBDET
Exit Function
Error_Handler:
srvZSWIFTB0_ZSWIHIB0 = Error
End Function

Public Function srvZSWIHIC0_GetBuffer_ODBC(rsado As ADODB.Recordset, lZSWIHIC0 As typeZSWIHIC0)
On Error GoTo Error_Handler
srvZSWIHIC0_GetBuffer_ODBC = Null
lZSWIHIC0.SWIHICETA = rsado("SWIHICETA")
lZSWIHIC0.SWIHICNUM = rsado("SWIHICNUM")
lZSWIHIC0.SWIHICNEN = rsado("SWIHICNEN")
lZSWIHIC0.SWIHICNLI = rsado("SWIHICNLI")
lZSWIHIC0.SWIHICNSE = rsado("SWIHICNSE")
lZSWIHIC0.SWIHICSOC = rsado("SWIHICSOC")
lZSWIHIC0.SWIHICNCH = rsado("SWIHICNCH")
lZSWIHIC0.SWIHICCOC = rsado("SWIHICCOC")
lZSWIHIC0.SWIHICNLC = rsado("SWIHICNLC")
lZSWIHIC0.SWIHICSEQ = rsado("SWIHICSEQ")
lZSWIHIC0.SWIHICCHA = rsado("SWIHICCHA")
lZSWIHIC0.SWIHICILI = rsado("SWIHICILI")
lZSWIHIC0.SWIHICFAC = rsado("SWIHICFAC")
lZSWIHIC0.SWIHICSIG = rsado("SWIHICSIG")
lZSWIHIC0.SWIHICSMA = rsado("SWIHICSMA")
lZSWIHIC0.SWIHICCMA = rsado("SWIHICCMA")
lZSWIHIC0.SWIHICSMI = rsado("SWIHICSMI")
lZSWIHIC0.SWIHICCMI = rsado("SWIHICCMI")
Exit Function
Error_Handler:
srvZSWIHIC0_GetBuffer_ODBC = Error
End Function
Public Function srvZSWIHIT0_GetBuffer_ODBC(rsado As ADODB.Recordset, lZSWIHIT0 As typeZSWIHIT0)
On Error GoTo Error_Handler
srvZSWIHIT0_GetBuffer_ODBC = Null
lZSWIHIT0.SWIHITETA = rsado("SWIHITETA")
lZSWIHIT0.SWIHITNUM = rsado("SWIHITNUM")
lZSWIHIT0.SWIHITNEN = rsado("SWIHITNEN")
lZSWIHIT0.SWIHITNSE = rsado("SWIHITNSE")
lZSWIHIT0.SWIHITSEQ = rsado("SWIHITSEQ")
lZSWIHIT0.SWIHITOSE = rsado("SWIHITOSE")
lZSWIHIT0.SWIHITCHA = rsado("SWIHITCHA")
lZSWIHIT0.SWIHITOCH = rsado("SWIHITOCH")
lZSWIHIT0.SWIHITIND = rsado("SWIHITIND")
lZSWIHIT0.SWIHITZON = rsado("SWIHITZON")
lZSWIHIT0.SWIHITOZO = rsado("SWIHITOZO")
lZSWIHIT0.SWIHITSZO = rsado("SWIHITSZO")
lZSWIHIT0.SWIHITOSZ = rsado("SWIHITOSZ")
lZSWIHIT0.SWIHITCON = rsado("SWIHITCON")
lZSWIHIT0.SWIHITCOM = rsado("SWIHITCOM")
lZSWIHIT0.SWIHITVAL = rsado("SWIHITVAL")
Exit Function
Error_Handler:
srvZSWIHIT0_GetBuffer_ODBC = Error
End Function
...
End Function
Public Function srvZSWITEM0_GetBuffer_ODBC(rsado As ADODB.Recordset, lZSWITEM0 As typeZSWITEM0)
On Error GoTo Error_Handler
srvZSWITEM0_GetBuffer_ODBC = Null
lZSWITEM0.SWITEMETA = rsado("SWITEMETA")
lZSWITEM0.SWITEMNUM = rsado("SWITEMNUM")
lZSWITEM0.SWITEMNEN = rsado("SWITEMNEN")
lZSWITEM0.SWITEMNSE = rsado("SWITEMNSE")
lZSWITEM0.SWITEMSEQ = rsado("SWITEMSEQ")
lZSWITEM0.SWITEMOSE = rsado("SWITEMOSE")
lZSWITEM0.SWITEMCHA = rsado("SWITEMCHA")
lZSWITEM0.SWITEMOCH = rsado("SWITEMOCH")
lZSWITEM0.SWITEMIND = rsado("SWITEMIND")
lZSWITEM0.SWITEMZON = rsado("SWITEMZON")
lZSWITEM0.SWITEMOZO = rsado("SWITEMOZO")
lZSWITEM0.SWITEMSZO = rsado("SWITEMSZO")
lZSWITEM0.SWITEMOSZ = rsado("SWITEMOSZ")
lZSWITEM0.SWITEMCON = rsado("SWITEMCON")
lZSWITEM0.SWITEMCOM = rsado("SWITEMCOM")
lZSWITEM0.SWITEMVAL = rsado("SWITEMVAL")
Exit Function
Error_Handler:
srvZSWITEM0_GetBuffer_ODBC = Error
End Function
...
End Sub
Public Sub srvZSWIHIA0_fgDisplay(lZSWIHIA0 As typeZSWIHIA0, fgDisplay As MSFlexGrid)
fgDisplay.Rows = 26
fgDisplay.Row = 1
fgDisplay.Col = 0: fgDisplay = "SWIHIAETA    4B"
fgDisplay.Col = 1: fgDisplay = "ETABLISSEMENT"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAETA
fgDisplay.Row = 2
fgDisplay.Col = 0: fgDisplay = "SWIHIAREF   16A"
fgDisplay.Col = 1: fgDisplay = "REFERNECE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAREF
fgDisplay.Row = 3
fgDisplay.Col = 0: fgDisplay = "SWIHIANEN    1A"
fgDisplay.Col = 1: fgDisplay = "NUMERO DE RENVOI"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIANEN
fgDisplay.Row = 4
fgDisplay.Col = 0: fgDisplay = "SWIHIAPRI    2A"
fgDisplay.Col = 1: fgDisplay = "CODE PROIRITE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAPRI
fgDisplay.Row = 5
fgDisplay.Col = 0: fgDisplay = "SWIHIAMES    3A"
fgDisplay.Col = 1: fgDisplay = "TYPE MESSAGE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAMES
fgDisplay.Row = 6
fgDisplay.Col = 0: fgDisplay = "SWIHIADOR   12A"
fgDisplay.Col = 1: fgDisplay = "DONNEUR ORDRE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIADOR
fgDisplay.Row = 7
fgDisplay.Col = 0: fgDisplay = "SWIHIADES   12A"
fgDisplay.Col = 1: fgDisplay = "DESTINATAIRE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIADES
fgDisplay.Row = 8
fgDisplay.Col = 0: fgDisplay = "SWIHIADVA    7P"
fgDisplay.Col = 1: fgDisplay = "DATE VALEUR"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIADVA
fgDisplay.Row = 9
fgDisplay.Col = 0: fgDisplay = "SWIHIADE1    3A"
fgDisplay.Col = 1: fgDisplay = "DEVISE 1"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIADE1
fgDisplay.Row = 10
fgDisplay.Col = 0: fgDisplay = "SWIHIAMON 15.2P"
fgDisplay.Col = 1: fgDisplay = "MONTANT"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAMON
fgDisplay.Row = 11
fgDisplay.Col = 0: fgDisplay = "SWIHIADE2    3A"
fgDisplay.Col = 1: fgDisplay = "DEVISE 2"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIADE2
fgDisplay.Row = 12
fgDisplay.Col = 0: fgDisplay = "SWIHIADEN    7P"
fgDisplay.Col = 1: fgDisplay = "DATE ENVOI"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIADEN
fgDisplay.Row = 13
fgDisplay.Col = 0: fgDisplay = "SWIHIAHEN    7P"
fgDisplay.Col = 1: fgDisplay = "HEURE ENVOI"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAHEN
fgDisplay.Row = 14
fgDisplay.Col = 0: fgDisplay = "SWIHIACOM    1A"
fgDisplay.Col = 1: fgDisplay = "COMPLET"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIACOM
fgDisplay.Row = 15
fgDisplay.Col = 0: fgDisplay = "SWIHIATES    1A"
fgDisplay.Col = 1: fgDisplay = "TEST OU REEL"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIATES
fgDisplay.Row = 16
fgDisplay.Col = 0: fgDisplay = "SWIHIASUP    1A"
fgDisplay.Col = 1: fgDisplay = "SUPPRIME"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIASUP
fgDisplay.Row = 17
fgDisplay.Col = 0: fgDisplay = "SWIHIAVAL    1A"
fgDisplay.Col = 1: fgDisplay = "TOP VALIDATION"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAVAL
fgDisplay.Row = 18
fgDisplay.Col = 0: fgDisplay = "SWIHIAAGE    4B"
fgDisplay.Col = 1: fgDisplay = "AGENCE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAAGE
fgDisplay.Row = 19
fgDisplay.Col = 0: fgDisplay = "SWIHIASER    2A"
fgDisplay.Col = 1: fgDisplay = "SERVICE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIASER
fgDisplay.Row = 20
fgDisplay.Col = 0: fgDisplay = "SWIHIASSE    2A"
fgDisplay.Col = 1: fgDisplay = "SOUS SERVICE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIASSE
fgDisplay.Row = 21
fgDisplay.Col = 0: fgDisplay = "SWIHIAUTI   10A"
fgDisplay.Col = 1: fgDisplay = "UTILISATEUR"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAUTI
fgDisplay.Row = 22
fgDisplay.Col = 0: fgDisplay = "SWIHIANUM    8P"
fgDisplay.Col = 1: fgDisplay = "NUMERO INTERNE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIANUM
fgDisplay.Row = 23
fgDisplay.Col = 0: fgDisplay = "SWIHIAUT1   10A"
fgDisplay.Col = 1: fgDisplay = "UTILISA SAISIE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAUT1
fgDisplay.Row = 24
fgDisplay.Col = 0: fgDisplay = "SWIHIAPVA    1A"
fgDisplay.Col = 1: fgDisplay = "1ERE VALIDATION"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAPVA
fgDisplay.Row = 25
fgDisplay.Col = 0: fgDisplay = "SWIHIAUT2   10A"
fgDisplay.Col = 1: fgDisplay = "UTILISA 1ER VALID"
fgDisplay.Col = 2: fgDisplay = lZSWIHIA0.SWIHIAUT2
End Sub
Public Sub srvZSWIHIB0_fgDisplay(lZSWIHIB0 As typeZSWIHIB0, fgDisplay As MSFlexGrid)
fgDisplay.Rows = 6
fgDisplay.Row = 1
fgDisplay.Col = 0: fgDisplay = "SWIHIBETA    4B"
fgDisplay.Col = 1: fgDisplay = "ETABLISSEMENT"
fgDisplay.Col = 2: fgDisplay = lZSWIHIB0.SWIHIBETA
fgDisplay.Row = 2
fgDisplay.Col = 0: fgDisplay = "SWIHIBNUM    8P"
fgDisplay.Col = 1: fgDisplay = "NUMERO INTERNE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIB0.SWIHIBNUM
fgDisplay.Row = 3
fgDisplay.Col = 0: fgDisplay = "SWIHIBNEN    1S"
fgDisplay.Col = 1: fgDisplay = "NUMERO ENVOI"
fgDisplay.Col = 2: fgDisplay = lZSWIHIB0.SWIHIBNEN
fgDisplay.Row = 4
fgDisplay.Col = 0: fgDisplay = "SWIHIBNLI    4P"
fgDisplay.Col = 1: fgDisplay = "NUMERO LIGNE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIB0.SWIHIBNLI
fgDisplay.Row = 5
fgDisplay.Col = 0: fgDisplay = "SWIHIBDET   70A"
fgDisplay.Col = 1: fgDisplay = "DETAIL"
fgDisplay.Col = 2: fgDisplay = lZSWIHIB0.SWIHIBDET
End Sub
Public Sub srvZSWIHIC0_fgDisplay(lZSWIHIC0 As typeZSWIHIC0, fgDisplay As MSFlexGrid)
fgDisplay.Rows = 19
fgDisplay.Row = 1
fgDisplay.Col = 0: fgDisplay = "SWIHICETA    4B"
fgDisplay.Col = 1: fgDisplay = "ETABLISSEMENT"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICETA
fgDisplay.Row = 2
fgDisplay.Col = 0: fgDisplay = "SWIHICNUM    8P"
fgDisplay.Col = 1: fgDisplay = "NUMERO INTERNE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICNUM
fgDisplay.Row = 3
fgDisplay.Col = 0: fgDisplay = "SWIHICNEN    1S"
fgDisplay.Col = 1: fgDisplay = "NUMERO ENVOI"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICNEN
fgDisplay.Row = 4
fgDisplay.Col = 0: fgDisplay = "SWIHICNLI    4P"
fgDisplay.Col = 1: fgDisplay = "NUMERO LIGNE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICNLI
fgDisplay.Row = 5
fgDisplay.Col = 0: fgDisplay = "SWIHICNSE   40A"
fgDisplay.Col = 1: fgDisplay = "NUMERO SEQUENCE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICNSE
fgDisplay.Row = 6
fgDisplay.Col = 0: fgDisplay = "SWIHICSOC    4P"
fgDisplay.Col = 1: fgDisplay = "NUM OCC SEQUE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICSOC
fgDisplay.Row = 7
fgDisplay.Col = 0: fgDisplay = "SWIHICNCH    2P"
fgDisplay.Col = 1: fgDisplay = "NUMERO CHAMP"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICNCH
fgDisplay.Row = 8
fgDisplay.Col = 0: fgDisplay = "SWIHICCOC    4P"
fgDisplay.Col = 1: fgDisplay = "NUM OCC CHAMP"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICCOC
fgDisplay.Row = 9
fgDisplay.Col = 0: fgDisplay = "SWIHICNLC    4P"
fgDisplay.Col = 1: fgDisplay = "NUMERO LIGNE CHAM"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICNLC
fgDisplay.Row = 10
fgDisplay.Col = 0: fgDisplay = "SWIHICSEQ    2A"
fgDisplay.Col = 1: fgDisplay = "DESCRIP SEQUENCE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICSEQ
fgDisplay.Row = 11
fgDisplay.Col = 0: fgDisplay = "SWIHICCHA    2A"
fgDisplay.Col = 1: fgDisplay = "DESCRIP CHAMP"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICCHA
fgDisplay.Row = 12
fgDisplay.Col = 0: fgDisplay = "SWIHICILI    1A"
fgDisplay.Col = 1: fgDisplay = "INDICATEUR DEB"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICILI
fgDisplay.Row = 13
fgDisplay.Col = 0: fgDisplay = "SWIHICFAC    1A"
fgDisplay.Col = 1: fgDisplay = "FACULTATIF"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICFAC
fgDisplay.Row = 14
fgDisplay.Col = 0: fgDisplay = "SWIHICSIG    1A"
fgDisplay.Col = 1: fgDisplay = "SIGNE COMPLET"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICSIG
fgDisplay.Row = 15
fgDisplay.Col = 0: fgDisplay = "SWIHICSMA    4P"
fgDisplay.Col = 1: fgDisplay = "OCCUR SEQ MAXIMUM"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICSMA
fgDisplay.Row = 16
fgDisplay.Col = 0: fgDisplay = "SWIHICCMA    4P"
fgDisplay.Col = 1: fgDisplay = "OCCUR CHA MAXIMUM"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICCMA
fgDisplay.Row = 17
fgDisplay.Col = 0: fgDisplay = "SWIHICSMI    2P"
fgDisplay.Col = 1: fgDisplay = "OCCUR SEQ MINIMUM"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICSMI
fgDisplay.Row = 18
fgDisplay.Col = 0: fgDisplay = "SWIHICCMI    2P"
fgDisplay.Col = 1: fgDisplay = "OCCUR CHA MINIMUM"
fgDisplay.Col = 2: fgDisplay = lZSWIHIC0.SWIHICCMI
End Sub
Public Sub srvZSWIHIT0_fgDisplay(lZSWIHIT0 As typeZSWIHIT0, fgDisplay As MSFlexGrid)
fgDisplay.Rows = 17
fgDisplay.Row = 1
fgDisplay.Col = 0: fgDisplay = "SWIHITETA    4B"
fgDisplay.Col = 1: fgDisplay = "ETABLISSEMENT"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITETA
fgDisplay.Row = 2
fgDisplay.Col = 0: fgDisplay = "SWIHITNUM    8P"
fgDisplay.Col = 1: fgDisplay = "NUMERO INTERNE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITNUM
fgDisplay.Row = 3
fgDisplay.Col = 0: fgDisplay = "SWIHITNEN    1S"
fgDisplay.Col = 1: fgDisplay = "NUMERO ENVOI"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITNEN
fgDisplay.Row = 4
fgDisplay.Col = 0: fgDisplay = "SWIHITNSE   40A"
fgDisplay.Col = 1: fgDisplay = "NUMERO SEQUENCE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITNSE
fgDisplay.Row = 5
fgDisplay.Col = 0: fgDisplay = "SWIHITSEQ    2A"
fgDisplay.Col = 1: fgDisplay = "SEQUENCE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITSEQ
fgDisplay.Row = 6
fgDisplay.Col = 0: fgDisplay = "SWIHITOSE    4P"
fgDisplay.Col = 1: fgDisplay = "OCCURENCE SEQUE."
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITOSE
fgDisplay.Row = 7
fgDisplay.Col = 0: fgDisplay = "SWIHITCHA    2P"
fgDisplay.Col = 1: fgDisplay = "CHAMP"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITCHA
fgDisplay.Row = 8
fgDisplay.Col = 0: fgDisplay = "SWIHITOCH    4P"
fgDisplay.Col = 1: fgDisplay = "OCCURENCE CHAMP"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITOCH
fgDisplay.Row = 9
fgDisplay.Col = 0: fgDisplay = "SWIHITIND    2A"
fgDisplay.Col = 1: fgDisplay = "INDICE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITIND
fgDisplay.Row = 10
fgDisplay.Col = 0: fgDisplay = "SWIHITZON    2P"
fgDisplay.Col = 1: fgDisplay = "ZONE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITZON
fgDisplay.Row = 11
fgDisplay.Col = 0: fgDisplay = "SWIHITOZO    4P"
fgDisplay.Col = 1: fgDisplay = "OCCURENCE ZONE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITOZO
fgDisplay.Row = 12
fgDisplay.Col = 0: fgDisplay = "SWIHITSZO    2P"
fgDisplay.Col = 1: fgDisplay = "SOUS ZONE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITSZO
fgDisplay.Row = 13
fgDisplay.Col = 0: fgDisplay = "SWIHITOSZ    4P"
fgDisplay.Col = 1: fgDisplay = "OCCURENCE S-ZONE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITOSZ
fgDisplay.Row = 14
fgDisplay.Col = 0: fgDisplay = "SWIHITCON    3P"
fgDisplay.Col = 1: fgDisplay = "COMPTEUR ENREGIS"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITCON
fgDisplay.Row = 15
fgDisplay.Col = 0: fgDisplay = "SWIHITCOM    1A"
fgDisplay.Col = 1: fgDisplay = "COMPLET"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITCOM
fgDisplay.Row = 16
fgDisplay.Col = 0: fgDisplay = "SWIHITVAL   65A"
fgDisplay.Col = 1: fgDisplay = "VALEUR ZONE"
fgDisplay.Col = 2: fgDisplay = lZSWIHIT0.SWIHITVAL
End Sub
...
End Sub
Public Sub srvZSWITEM0_fgDisplay(lZSWITEM0 As typeZSWITEM0, fgDisplay As MSFlexGrid)
fgDisplay.Rows = 17
fgDisplay.Row = 1
fgDisplay.Col = 0: fgDisplay = "SWITEMETA    4B"
fgDisplay.Col = 1: fgDisplay = "ETABLISSEMENT"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMETA
fgDisplay.Row = 2
fgDisplay.Col = 0: fgDisplay = "SWITEMNUM    8P"
fgDisplay.Col = 1: fgDisplay = "NUMERO INTERNE"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMNUM
fgDisplay.Row = 3
fgDisplay.Col = 0: fgDisplay = "SWITEMNEN    1S"
fgDisplay.Col = 1: fgDisplay = "NUMERO ENVOI"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMNEN
fgDisplay.Row = 4
fgDisplay.Col = 0: fgDisplay = "SWITEMNSE   40A"
fgDisplay.Col = 1: fgDisplay = "NUMERO SEQUENCE"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMNSE
fgDisplay.Row = 5
fgDisplay.Col = 0: fgDisplay = "SWITEMSEQ    2A"
fgDisplay.Col = 1: fgDisplay = "SEQUENCE"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMSEQ
fgDisplay.Row = 6
fgDisplay.Col = 0: fgDisplay = "SWITEMOSE    4P"
fgDisplay.Col = 1: fgDisplay = "OCCURENCE SEQUE."
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMOSE
fgDisplay.Row = 7
fgDisplay.Col = 0: fgDisplay = "SWITEMCHA    2P"
fgDisplay.Col = 1: fgDisplay = "CHAMP"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMCHA
fgDisplay.Row = 8
fgDisplay.Col = 0: fgDisplay = "SWITEMOCH    4P"
fgDisplay.Col = 1: fgDisplay = "OCCURENCE CHAMP"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMOCH
fgDisplay.Row = 9
fgDisplay.Col = 0: fgDisplay = "SWITEMIND    2A"
fgDisplay.Col = 1: fgDisplay = "INDICE"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMIND
fgDisplay.Row = 10
fgDisplay.Col = 0: fgDisplay = "SWITEMZON    2P"
fgDisplay.Col = 1: fgDisplay = "ZONE"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMZON
fgDisplay.Row = 11
fgDisplay.Col = 0: fgDisplay = "SWITEMOZO    4P"
fgDisplay.Col = 1: fgDisplay = "OCCURENCE ZONE"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMOZO
fgDisplay.Row = 12
fgDisplay.Col = 0: fgDisplay = "SWITEMSZO    2P"
fgDisplay.Col = 1: fgDisplay = "SOUS ZONE"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMSZO
fgDisplay.Row = 13
fgDisplay.Col = 0: fgDisplay = "SWITEMOSZ    4P"
fgDisplay.Col = 1: fgDisplay = "OCCURENCE S-ZONE"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMOSZ
fgDisplay.Row = 14
fgDisplay.Col = 0: fgDisplay = "SWITEMCON    3P"
fgDisplay.Col = 1: fgDisplay = "COMPTEUR ENREGIS"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMCON
fgDisplay.Row = 15
fgDisplay.Col = 0: fgDisplay = "SWITEMCOM    1A"
fgDisplay.Col = 1: fgDisplay = "COMPLET"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMCOM
fgDisplay.Row = 16
fgDisplay.Col = 0: fgDisplay = "SWITEMVAL   65A"
fgDisplay.Col = 1: fgDisplay = "VALEUR ZONE"
fgDisplay.Col = 2: fgDisplay = lZSWITEM0.SWITEMVAL
End Sub
