...
Option Explicit
'---------------------------------------------------------
Public Const recGAdresseLen = 213 ' 34 + 179
...
If recGAdresse.Err = Space$(10) Then
    ...
    recGAdresse.L0 = mId$(MsgTxt, K + 20, 32)
    recGAdresse.L2 = mId$(MsgTxt, K + 52, 32)
    recGAdresse.L3 = mId$(MsgTxt, K + 84, 32)
    recGAdresse.L4 = mId$(MsgTxt, K + 116, 32)
    recGAdresse.CodePostal = mId$(MsgTxt, K + 148, 5)
    recGAdresse.Pays = mId$(MsgTxt, K + 153, 2)
    
    recGAdresse.ElpId = CLng(Val(mId$(MsgTxt, K + 155, 12)))
    recGAdresse.ElpUpdate = CInt(Val(mId$(MsgTxt, K + 167, 3)))
    recGAdresse.ElpControl = mId$(MsgTxt, K + 170, 10)
...
Mid$(MsgTxt, K + 20, 32) = recGAdresse.L0
Mid$(MsgTxt, K + 52, 32) = recGAdresse.L2
Mid$(MsgTxt, K + 84, 32) = recGAdresse.L3
Mid$(MsgTxt, K + 116, 32) = recGAdresse.L4
Mid$(MsgTxt, K + 148, 5) = recGAdresse.CodePostal
Mid$(MsgTxt, K + 153, 2) = recGAdresse.Pays

Mid$(MsgTxt, K + 155, 12) = Format$(recGAdresse.ElpId, "000000000000")
Mid$(MsgTxt, K + 167, 3) = Format$(recGAdresse.ElpUpdate, "000")
Mid$(MsgTxt, K + 170, 10) = recGAdresse.ElpControl
