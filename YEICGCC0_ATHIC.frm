...
Begin VB.Form frmYEICGCC0_ATHIC 
   AutoRedraw      =   -1  'True
   Caption         =   "Gestion des chèques circulants (ATHIC)"
   ClientHeight    =   10530
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   13575
   Icon            =   "YEICGCC0_ATHIC.frx":0000
   LinkTopic       =   "Form1"
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "YEICGCC0_ATHIC.frx":030A
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "fraTab0"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Paramétrage"
      TabPicture(1)   =   "YEICGCC0_ATHIC.frx":0326
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "fraParam"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "."
      TabPicture(2)   =   "YEICGCC0_ATHIC.frx":0342
      ...
      Begin MSFlexGridLib.MSFlexGrid fgLogV 
         ...
         FormatString    =   $"YEICGCC0_ATHIC.frx":036A
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "@Arial Unicode MS"
            Size            =   7.5
            Charset         =   0
      ...
      Begin VB.Frame fraTab0 
         ...
         Begin MSFlexGridLib.MSFlexGrid fgSelect 
            ...
            GridLinesFixed  =   1
            AllowUserResizing=   3
            FormatString    =   $"YEICGCC0_ATHIC.frx":0462
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Arial Unicode MS"
               Size            =   7.5
               Charset         =   0
   ...
   Begin VB.CommandButton cmdPrint 
      ...
      Height          =   500
      Left            =   13080
      Picture         =   "YEICGCC0_ATHIC.frx":0548
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   0
      Width           =   500
   ...
   End
End
Attribute VB_Name = "frmYEICGCC0_ATHIC"
...
Dim rsADO_ATHIC As New ADODB.Recordset
...
Private Sub cmdPrint_Auto_xlsManual()
...
ReDim nbSheetRows(1 To 6)
'                                               '
Call init_xlsManual
'On recopie le classeur modèle de c:\BIASRV vers c:\temp\imp_pdf
FileCopy paramFolder_Local & "\Modeles\modele_EIC_GCC.xlsx", paramIMP_PDF_Path_Temp & "\modele_EIC_GCC.xlsx"
'on charge CE classeur dans Excel
Call appExcelPublic.Workbooks.Open(paramIMP_PDF_Path_Temp & "\modele_EIC_GCC.xlsx")
...
wbExcel.Sheets("EVENEMENTS").Activate
X = cmdPrint_Title & " " & dateImp10(DSys)
prtYEICGCC0_Init "YEICGCCLOG", X
currentRow = 1
wbExcel.Sheets("EVENEMENTS").Cells(currentRow, 4) = prtTitleText
currentRow = 6
comptageRows = currentRow
maxRows = 33
maxRowsPlus = 3
For I = 1 To arrYEICGCCLOG_Nb
    Call prtYEICGCCLOG_Line_xlsManual(arrYEICGCCLOG(I), currentRow, wbExcel.Sheets("EVENEMENTS"), comptageRows, maxRows, maxRowsPlus)
Next I
...
Selection.Delete
currentRow = currentRow - 3
currentSheet = impressions_xlsManual.indice_feuille_modele("EVENEMENTS", wbExcel)
nbSheetRows(currentSheet) = currentRow
'///////////////////////////////////////////////////////////////////////////////'
cmdSelect_SQL_K = "E"
cmdSelect_SQL_Echeancier
X = cmdPrint_Title
prtYEICGCC0_Init "Echéancier", X
wbExcel.Sheets("ECHEANCIER").Activate
currentRow = 1
wbExcel.Sheets("ECHEANCIER").Cells(currentRow, 4) = prtTitleText
currentRow = 6
comptageRows = currentRow
maxRows = 33
maxRowsPlus = 3
For I = 1 To arrYEICGCC0_Nb
    Call prtYEICGCC0_Line_Echéancier_xlsManual(arrYEICGCC0(I), arrYEICGCCLOG(I), currentRow, wbExcel.Sheets("ECHEANCIER"), comptageRows, maxRows, maxRowsPlus)
Next I
'on supprime les 3 lignes du modèle
Rows("4:6").Select
Selection.Delete
currentRow = currentRow - 3
currentSheet = impressions_xlsManual.indice_feuille_modele("ECHEANCIER", wbExcel)
nbSheetRows(currentSheet) = currentRow
'///////////////////////////////////////////////////////////////////////////////'
cmdSelect_SQL_K = "2e"
cmdSelect_SQL_2e
...
wbExcel.Sheets("EIC_REM").Activate
currentRow = 1
wbExcel.Sheets("EIC_REM").Cells(currentRow, 4) = prtTitleText
currentRow = 6
comptageRows = currentRow
maxRows = 33
maxRowsPlus = 3
For I = 1 To arrYEICGCC0_Nb
    If arrYEICGCC0(I).EICGCCAGE < wDSYS_5J Then
        Call prtYEICGCC0_Line_xlsManual(arrYEICGCC0(I), currentRow, wbExcel.Sheets("EIC_REM"), comptageRows, maxRows, maxRowsPlus)
    End If
Next I
'on supprime les 3 lignes du modèle
Rows("4:6").Select
Selection.Delete
currentRow = currentRow - 3
currentSheet = impressions_xlsManual.indice_feuille_modele("EIC_REM", wbExcel)
nbSheetRows(currentSheet) = currentRow
'///////////////////////////////////////////////////////////////////////////////'
cmdSelect_SQL_K = "2?"
cmdSelect_SQL_2vo
X = cmdPrint_Title
prtYEICGCC0_Init "YEICGCC0", X
wbExcel.Sheets("ORPHELINES").Activate
currentRow = 1
wbExcel.Sheets("ORPHELINES").Cells(currentRow, 4) = prtTitleText
currentRow = 6
comptageRows = currentRow
maxRows = 33
maxRowsPlus = 3
For I = 1 To arrYEICGCC0_Nb
    Call prtYEICGCC0_Line_xlsManual(arrYEICGCC0(I), currentRow, wbExcel.Sheets("ORPHELINES"), comptageRows, maxRows, maxRowsPlus)
Next I
'on supprime les 3 lignes du modèle
Rows("4:6").Select
Selection.Delete
currentRow = currentRow - 3
currentSheet = impressions_xlsManual.indice_feuille_modele("ORPHELINES", wbExcel)
nbSheetRows(currentSheet) = currentRow
'///////////////////////////////////////////////////////////////////////////////'
cmdSelect_SQL_K = "2v"
cmdSelect_SQL_2v
X = cmdPrint_Title
prtYEICGCC0_Init "YEICGCC0", X
wbExcel.Sheets("A_CONTROLER").Activate
currentRow = 1
wbExcel.Sheets("A_CONTROLER").Cells(currentRow, 4) = prtTitleText
currentRow = 6
comptageRows = currentRow
maxRows = 33
maxRowsPlus = 3
For I = 1 To arrYEICGCC0_Nb
    Call prtYEICGCC0_Line_xlsManual(arrYEICGCC0(I), currentRow, wbExcel.Sheets("A_CONTROLER"), comptageRows, maxRows, maxRowsPlus)
Next I
'on supprime les 3 lignes du modèle
Rows("4:6").Select
Selection.Delete
currentRow = currentRow - 3
currentSheet = impressions_xlsManual.indice_feuille_modele("A_CONTROLER", wbExcel)
nbSheetRows(currentSheet) = currentRow
...
ReDim ar(1 To 6)
For ii = 1 To 6
    Call zoneImpression_xlsManual(wbExcel.Sheets(ii).Name, nbSheetRows(ii), wbExcel.Sheets(ii))
    ar(ii) = wbExcel.Sheets(ii).Name
Next ii
...
Set wbExcel = Nothing
Kill paramIMP_PDF_Path_Temp & "\modele_EIC_GCC.xlsx"
...
If arrHab(2) Or arrHab(3) Or arrHab(5) Then
    cmdDetail_Action.Visible = True
...
Select Case wEICGCCSTA
    Case "V":
            ...
            Else
                If arrHab(2) And Trim(txtDetail_EICGCCVEXT) = "" Then
                    txtDetail_EICGCCVEXT.Enabled = True
                End If
            End If
    Case " ":
...
wSendMail.Attachment = "" '$JPL 2010-10-10  prtIMP_PDF_FileName
...
'Call MsgBox("imgCHQ_Load : ATHIC en cours", vbInformation, "EICGCC ATHIC")
'Exit Sub

xPath_ImgCHQ = imgCHQ_Path(lDate, lImage)
...
If lDate < "20120000" Then
    xImage = Format$(lImage, "00000000")
Else
    xImage = Format$(lImage, "000000000")
End If

xPath_ImgCHQ = Replace(xPath_ImgCHQ, "\" & xImage, "\ba" & xImage)
If Dir(xPath_ImgCHQ) <> "" Then
...
Public Function imgCHQ_Path(lDate As Long, lImage As Long) As String
Dim xImage As String
If lDate < "20120000" Then
    xImage = Format$(lImage, "00000000")
Else
...
Set rsADO_ATHIC = cnADO_ATHIC.Execute("select PATH from CHEQUE Where Date = '" & lDate & "' and Image = '" & xImage & "'")

If Not rsADO_ATHIC.EOF Then

    imgCHQ_Path = Replace(rsADO_ATHIC("PATH"), "I:\ATHIC\", paramATHIC_Images) & "\" & xImage & ".jpg"
End If
...
Select Case wFct
    Case "@EIC_GCC": blnAuto = True
                    ...
                    Call frmElpPrt.prtIMP_PDF_NoPaper_Init("S01", "BIA-EIC-GCC", "Archive")
                    cmdSelect_SQL_Import_EIC
                    cmdSelect_SQL_Import_REM
                    cmdSelect_SQL_Import_Vignettes
                    If xlsManual Then
                        Call cmdPrint_Auto_xlsManual
                    Else
                        cmdPrint_Auto
                    End If
                    cmdSendMail_EIC_GCC
...
If arrHab(2) Or arrHab(3) Or arrHab(5) Then
    fraDetail_V.Enabled = True
    fraDetail_X.Enabled = True
    fraDetail_K.Enabled = True
Else
    fraDetail_V.Enabled = False
    fraDetail_X.Enabled = False
    fraDetail_K.Enabled = False
End If
...
If Not rsSab.EOF Then
    ...
    cmdParam_Delete.Visible = arrHab(5)
    cmdParam_Update.Visible = arrHab(5)
...
'cnADO_ATHIC.Properties("JET OLEDB:Database Password") = lDataBase_PassWord
...
If UCase$(X) <> UCase$(cnADO_ATHIC.Properties("Data Source Name")) Then
    MsgBox X, vbCritical, "DSN 'CHEQUE.mdb' non conforme "
    cnAdo_Info cnADO_ATHIC
    End
End If
...
wSendMail.Attachment = imgCHQ_Path(Trim(oldYEICGCC0.EICGCCVAMJ), oldYEICGCC0.EICGCCVJPG)
...
wSendMail.Message = "<body bgcolor = #FFFFFF>" _
                    ...
                    & "<BR><BR> Bien entendu, si cette opération est conforme avec l'activité de votre client," _
                    & "<BR> nous vous remercions de bien vouloir nous marquer votre accord par retour." _
...
Do While Not rsSab.EOF
    ...
    If blnFiltre Then
        'If wEICGCCEMT >= getSeuil1YEICGCC0 Then blnOk = True
        If wEICGCCEMT >= 10000 Then blnOk = True
            ...
            Else
                ...
                Else
                    ...
                    If newYEICGCC0.EICGCCOPE = "REM" Then
                        ...
                        'If newYEICGCC0.EICGCCEIND = "8" And newYEICGCC0.EICGCCEMT < getSeuil1YEICGCC0 Then
                        If newYEICGCC0.EICGCCEIND = "8" And newYEICGCC0.EICGCCEMT < 10000 Then
                            newYEICGCC0.EICGCCSTA = "@"
                        End If
                    End If
...
If mCLIENARES <> lCLIENARES Then
    ...
    If Not rsSab.EOF Then
        ...
        mCLIENARES_Lib = Trim(Mid$(X, 1, 30))
        mMNURUTUTI = Trim(Mid$(X, 36, 10))
    End If
End If
End Sub
...
'    End If
'End If
mMNUUTIMAI = mailAdresse_Production(mMNURUTUTI)
If mMNUUTIMAI = "" Then
...
xSQL = "select count(*) as Tally from " & paramIBM_Library_SABSPE_XXX & ".YEICGCCLOG" _
       & xWhereLog & " and EICGCCLOGK = 'Mail DCOM' and EICGCCLOGA <> 'A' "
Set rsSab = cnsab.Execute(xSQL)

Nb = rsSab("Tally")
fgSelect.Col = 0: fgSelect.Text = "Nombre de Mail DCOM (émis)"
fgSelect.Col = 1: fgSelect.Text = Format$(Nb, "### ##0")
fgSelect.CellFontBold = True
fgSelect.CellBackColor = vbCyan
'____________________________________________________________________________________
...
Nb = rsSab("Tally")
fgSelect.Col = 0: fgSelect.Text = "Nombre de Mail DCOM * (validation au culot)"
fgSelect.Col = 1: fgSelect.Text = Format$(Nb, "### ##0")
fgSelect.CellFontBold = True
fgSelect.CellBackColor = vbCyan
'____________________________________________________________________________________
