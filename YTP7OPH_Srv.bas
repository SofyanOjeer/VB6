...
'===================================================================================
If oldY.ICCCPTUAMJ <> newY.ICCCPTUAMJ _
...
xWhere = " where ICCCPTUAMJ = " & oldY.ICCCPTUAMJ _
...
If newY.ICCCPTCOM <> oldY.ICCCPTCOM Then blnUpdate = True:  xSet = xSet & " , ICCCPTCOM = '" & newY.ICCCPTCOM & "'"
If newY.ICCCPTDEV <> oldY.ICCCPTDEV Then blnUpdate = True:  xSet = xSet & " , ICCCPTDEV = '" & Replace(Trim(newY.ICCCPTDEV), "'", "''") & "'"


If newY.ICCCPTETA <> oldY.ICCCPTETA Then blnUpdate = True:  xSet = xSet & " , ICCCPTETA = " & newY.ICCCPTETA
If newY.ICCCPTAGE <> oldY.ICCCPTAGE Then blnUpdate = True:  xSet = xSet & " , ICCCPTAGE = " & newY.ICCCPTAGE
