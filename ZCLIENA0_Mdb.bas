Attribute VB_Name = "mdbZCLIENA0"
'---------------------------------------------------------
Option Explicit
'---------------------------------------------------------
Public rsYCLIENA0 As Recordset
Dim blnZCLIENA0_Open As Boolean
'---------------------------------------------------------
'-----------------------------------------------------
Sub mdbZCLIENA0_Close_Rs()
'-----------------------------------------------------
If blnZCLIENA0_Open Then
    rsYCLIENA0.Close
    blnZCLIENA0_Open = False
End If
...
'-----------------------------------------------------
Sub mdbZCLIENA0_Open_Rs()
'-----------------------------------------------------

If Not blnZCLIENA0_Open Then
    Set rsYCLIENA0 = MDB.OpenRecordset("ZCLIENA0")
    rsYCLIENA0.Index = "PrimaryKey"
    blnZCLIENA0_Open = True
End If
End Sub

'---------------------------------------------------------
Public Function mdbZCLIENA0_Read_Rs(lMethod As String, recYCLIENA0 As typeYCLIENA0)
'---------------------------------------------------------

On Error GoTo Error_Handler

mdbZCLIENA0_Read_Rs = Null


Select Case Trim(lMethod)
     Case "Seek=", "AddNew", "Update", "Delete"

                        rsYCLIENA0.Seek "=", recYCLIENA0.CLIENAETB, recYCLIENA0.CLIENACLI
...
If lMethod <> "AddNew" Then
    Call mdbZCLIENA0_GetBuffer_Rs(recYCLIENA0)
End If
...
'---------------------------------------------------------
    ...
    Resume Next
    mdbZCLIENA0_Read_Rs = Error

End Function

'---------------------------------------------------------
Public Function mdbZCLIENA0_Update_Rs(lMethod As String, recYCLIENA0 As typeYCLIENA0)
'---------------------------------------------------------
On Error GoTo Error_Handler
mdbZCLIENA0_Update_Rs = Null

Select Case Trim(lMethod)

    Case "AddNew"
                        rsYCLIENA0.AddNew
                        Call mdbZCLIENA0_PutBuffer_Rs(recYCLIENA0)
                        rsYCLIENA0.Update
    Case "Update"
                        rsYCLIENA0.Edit
                        Call mdbZCLIENA0_PutBuffer_Rs(recYCLIENA0)
...
Public Function mdbZCLIENA0_GetBuffer_Rs(recYCLIENA0 As typeYCLIENA0)
On Error GoTo Error_Handler
mdbZCLIENA0_GetBuffer_Rs = Null
...
Exit Function
Error_Handler:
mdbZCLIENA0_GetBuffer_Rs = Error
End Function
Public Function mdbZCLIENA0_PutBuffer_Rs(recYCLIENA0 As typeYCLIENA0)
On Error GoTo Error_Handler
mdbZCLIENA0_PutBuffer_Rs = Null
...
Exit Function
Error_Handler:
mdbZCLIENA0_PutBuffer_Rs = Error
End Function
