   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame fraDossier 
         ...
         Begin VB.ListBox lstOptions 
            ...
            EndProperty
            Height          =   4650
            ItemData        =   "SAB_JRN.frx":037A
            Left            =   7320
            List            =   "SAB_JRN.frx":0381
            Style           =   1  'Checkbox
            TabIndex        =   6
            Top             =   360
            Width           =   5805
...
If meYBIACRE.YCREAVI0_Nb > 0 Then meYBIACRE.YCREAVI0_Index = 2

If fgDossier.Rows > 1 Then
    For prtI = 1 To meYBIACRE.prtNb
        Select Case SSTab1.Tab
            Case 1: prtSAB_CRE_Monitor lstOptions, meYBIACRE
            Case Else:
